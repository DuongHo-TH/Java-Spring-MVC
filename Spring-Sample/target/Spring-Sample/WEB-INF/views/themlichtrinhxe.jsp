...
<body>
	<div class="container w-50">
		...
		<form:form action="${pageContext.request.contextPath}/savelichtrinh"
			...
			<label for="xe.maxe" class="form-check-label">Mã Xe</label>
			<form:select path="xe.maxe" name="xe.maxe"
				items="${listxe}" id="xe.maxe" itemValue="maxe"
				itemLabel="maxe" class="form-select"
				aria-label="Default select example"
				aria-describedby="addon-wrapping">
			</form:select>
			<form:errors path="xe.maxe" cssClass="error text-danger"></form:errors>
