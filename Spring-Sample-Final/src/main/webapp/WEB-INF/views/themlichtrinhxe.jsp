...
<body>
	<div class="container w-50">
		...
		<form:form action="${pageContext.request.contextPath}/savelichtrinh"
			class="form-control " method="POST" modelAttribute="lichtrinh">

			<label for="idlichtrinh.maxe" class="form-check-label">Mã Xe</label>
			<form:select path="idlichtrinh.maxe" name="idlichtrinh.maxe"
				items="${listxe}" id="idlichtrinh.maxe" itemValue="maxe"
			...
			<form:select path="tuyenxe.matuyen" name="tuyenxe.matuyen"
				items="${listtuyenxe}" id="tuyenxe.matuyen" itemValue="matuyen"
