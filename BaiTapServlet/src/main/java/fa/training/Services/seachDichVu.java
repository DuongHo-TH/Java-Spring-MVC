...
/**
 * Servlet implementation class seachDichVu
 */
@WebServlet(value = "/seachdv")
public class seachDichVu extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("listdv", dichvuDao.displaytenKhach(seach));
		int pagenumber  = 1;
